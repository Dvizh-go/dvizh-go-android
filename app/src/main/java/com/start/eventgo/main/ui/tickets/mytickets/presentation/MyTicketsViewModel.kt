package com.start.eventgo.main.ui.tickets.mytickets.presentation
...
import com.start.eventgo.main.ui.tickets.mytickets.data.model.state.CanceledTicketsState
import com.start.eventgo.main.ui.tickets.mytickets.data.model.state.FinishedTicketsState
    ...
    fun getUserUpcomingTickets(
        ...
        launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                when (response) {
                    is Response.Success ->
                        userUpcomingTicketsStateLiveData.value =
    ...
    fun getUserFinishedTickets(
        ...
        launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                when (response) {
                    is Response.Success ->
                        userFinishedTicketsStateLiveData.value =
    ...
    fun getUserCanceledTickets(
        ...
        launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                when (response) {
                    is Response.Success ->
                        userCanceledTicketsStateLiveData.value =
